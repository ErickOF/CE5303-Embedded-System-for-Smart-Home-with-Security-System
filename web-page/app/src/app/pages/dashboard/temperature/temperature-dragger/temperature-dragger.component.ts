...
export class TemperatureDraggerComponent implements AfterViewInit, OnChanges {
  ...
  private calculateGradientConePaths(angleStep: any) {
  ...
  private recalculateValue(event: any, allowJumping = false) {
  ...
  private toValueNumber(factor: any) {
